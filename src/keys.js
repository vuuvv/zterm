...
let termKeyConfig = [
  ...
  ['Enter'         , char(0x0d)  , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['Space'         , char(0x20)  , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['Tab'           , char(0x09)  , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['Backspace'     , char(0x7f)  , false     , char(0x1f) , char(0x17) , char(0x08) , ''  , ''  , ''] ,
  ['Delete'        , alt("[3~")  , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['End'           , alt("[F")  , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['Home'          , alt("[H") ,  false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['Insert'        , alt("[2~")  , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['PageDown'      , alt("[6~")  , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['PageUp'        , alt("[5~")  , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['ArrowUp'       , alt("[A")   , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['ArrowDown'     , alt("[B")   , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['ArrowRight'    , alt("[C")   , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['ArrowLeft'     , alt("[D")   , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
  ['Escape'        , char(0x1b)  , false     , ''         , ''         , ''         , ''  , ''  , ''] ,
...
function translate(key) {
  ...
  let termkey = termKeyMap[keyname];
  if (termkey) {
    if(termkey[ATTR.PRINTABLE] && !key.ctrlKey && !key.altKey) {
      return false;
    }
    let code = termkey[ATTR.CODE];
    let modify = [];
    if (key.ctrlKey) {
      modify.push("C");
    }
